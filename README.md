...
Example
```csharp
throw new RequestEntityTooLargeException("My custom message");
```

If you would like to stay with constructor without parameters,
```csharp
throw new RequestEntityTooLargeException();
```
the exception message will be "The server will not accept the request, because the request entity is too large"
...
Class that contains list of the messages:
